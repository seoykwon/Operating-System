...
main(void)
{
  ...
  52:	e8 79 04 00 00       	call   4d0 <printf>
    // edited
    printf(1, "Student ID: 2020312627\n");
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
  59:	68 43 08 00 00       	push   $0x843
  5e:	6a 01                	push   $0x1
  60:	e8 6b 04 00 00       	call   4d0 <printf>
    printf(1, "Name: Seoyoung Kwon\n");
  65:	59                   	pop    %ecx
  66:	5b                   	pop    %ebx
  67:	68 5b 08 00 00       	push   $0x85b
  6c:	6a 01                	push   $0x1
  6e:	e8 5d 04 00 00       	call   4d0 <printf>
    // printf(1, "I think I solved the first assignmnet of my OS course! So happy! XD\n");
  ...
  c3:	68 83 08 00 00       	push   $0x883
  c8:	e8 cd 02 00 00       	call   39a <exec>
      printf(1, "init: exec sh failed\n");
  cd:	5a                   	pop    %edx
  ce:	59                   	pop    %ecx
  cf:	68 86 08 00 00       	push   $0x886
  d4:	6a 01                	push   $0x1
  d6:	e8 f5 03 00 00       	call   4d0 <printf>
      exit();
  ...
  e1:	6a 01                	push   $0x1
  e3:	6a 01                	push   $0x1
  e5:	68 28 08 00 00       	push   $0x828
  ea:	e8 bb 02 00 00       	call   3aa <mknod>
    open("console", O_RDWR);
  ef:	58                   	pop    %eax
  f0:	5a                   	pop    %edx
  f1:	6a 02                	push   $0x2
  f3:	68 28 08 00 00       	push   $0x828
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb a5 08 00 00       	mov    $0x8a5,%ebx
        while(*s != 0){
 ...
 6a1:	a1 5c 0b 00 00       	mov    0xb5c,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 5c 0b 00 00       	mov    %eax,0xb5c
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 77f:	73 47                	jae    7c8 <malloc+0x98>
    ...
    if(p == freep)
 781:	39 05 5c 0b 00 00    	cmp    %eax,0xb5c
 ...
 7a6:	e8 f5 fe ff ff       	call   6a0 <free>
  return freep;
 7ab:	8b 15 5c 0b 00 00    	mov    0xb5c,%edx
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 5c 0b 00 00    	mov    %edx,0xb5c
}
 ...
 7f7:	0b 00 00 
 7fa:	c7 05 60 0b 00 00 60 	movl   $0xb60,0xb60
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 60 0b 00 00       	mov    $0xb60,%eax
