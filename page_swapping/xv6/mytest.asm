 ...
 339:	85 d2                	test   %edx,%edx
{
 ...
 3a0:	e8 dd fe ff ff       	call   282 <write>
...
printf(int fd, const char *fmt, ...)
{
 ...
 410:	e8 6d fe ff ff       	call   282 <write>
 ...
 488:	31 ff                	xor    %edi,%edi
  write(fd, &c, 1);
 48a:	e8 f3 fd ff ff       	call   282 <write>
  for(i = 0; fmt[i]; i++){
 ...
 523:	57                   	push   %edi
 524:	53                   	push   %ebx
 525:	e8 58 fd ff ff       	call   282 <write>
        while(*s != 0){
 ...
 577:	e8 06 fd ff ff       	call   282 <write>
        ap++;
 ...
 5a1:	a1 d0 09 00 00       	mov    0x9d0,%eax
{
 ...
 5dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5df:	a3 d0 09 00 00       	mov    %eax,0x9d0
}
 5e4:	5b                   	pop    %ebx
 5e5:	5e                   	pop    %esi
 5e6:	5f                   	pop    %edi
 ...
 5f6:	72 ce                	jb     5c6 <free+0x26>
{
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 d0 09 00 00       	mov    %eax,0x9d0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 68e:	56                   	push   %esi
 68f:	e8 56 fc ff ff       	call   2ea <sbrk>
  if(p == (char*)-1)
 ...
 6d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6d7:	89 15 d0 09 00 00    	mov    %edx,0x9d0
}
 ...
 6f7:	09 00 00 
 6fa:	c7 05 d4 09 00 00 d4 	movl   $0x9d4,0x9d4
 701:	09 00 00 
    base.s.size = 0;
 704:	b8 d4 09 00 00       	mov    $0x9d4,%eax
 709:	c7 05 d8 09 00 00 00 	movl   $0x0,0x9d8
 710:	00 00 00 
